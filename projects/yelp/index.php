...
?>
	<tr><td><a href="restaurant.php?id=<?=urlencode($r->id)?>"><button type="button" class="btn btn-success">View</button></a></td><td><?=$r->name?></td><td><?=$r->rating?></td><td><?=$r->neighborhood?></td><td><?=$r->address?></td></tr>
<?php
	}
?>
</tbody>
